...
text contains at least one word.
     ...
     */
    class RearrangeSpaceBetweenWords
    {
        ...
        public string ReorderSpaces(string text)
        {
            ...
            // Extract words (non-empty strings between spaces)
            ...
            // Calculate space between words and space at the end
            int spaceBetweenWords = totalSpaces / (wordCount - 1);
            int remainingSpaces = totalSpaces % (wordCount - 1);

            // Build the result
            string separator = new string(' ', spaceBetweenWords);
            string result = string.Join(separator, words) + new string(' ', remainingSpaces);
